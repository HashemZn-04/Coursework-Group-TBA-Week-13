...
```bash
python scripts/h1_demo.py     # H1 — next-month-ahead travel spend forecast
...
|---|---|---|
| Spend Overview | E2, H2 | Claimed / approved / at-risk / **prevented**, per currency; spend velocity; the running total of leakage prevented; spend by category; next-month travel forecast (headline RMSE/R², two further months plotted for context) |
...
api/                   Audit engine
  ...
  forecast.py          H1 — next-month-ahead travel spend regression (plus two further months of context), and its refusals
